...
(function (A, w) {
            ...
            for (r = j.length; n < r; n++)
                for (k = 0; k < u.length; k++) {
                    ...
                    if (j[n].selector === i.selector) {
                        ...
                        f = null;
                        if (
                            i.preType === "mouseenter" ||
                            i.preType === "mouseleave"
                        )
    ...
    (function () {
        ...
        if (!(!e || !e.length || !j)) {
            c.support = {
                ...
                parentNode:
                    d.removeChild(d.appendChild(s.createElement("div")))
                        .parentNode === null,
                deleteExpando: true,
                checkClone: false,
                scriptEval: false,
    ...
    c.fn.extend({
        ...
        addClass: function (a) {
            ...
            if (a && typeof a === "string")
                for (
                    var b = (a || "").split(ca), d = 0, f = this.length;
                    d < f;
                    d++
                ) {
                    var e = this[d];
        ...
        toggleClass: function (a, b) {
            ...
            return this.each(function () {
                if (d === "string")
                    ...
                    this.className &&
                        c.data(this, "__className__", this.className);
                    this.className =
            ...
            if (a === w) {
                ...
                if (b) {
                    if (c.nodeName(b, "option"))
                        return (b.attributes.value || {}).specified
                            ? b.value
                            : b.text;
                    ...
                    if (Ba.test(b.type) && !c.support.checkOn)
                        return b.getAttribute("value") === null
                            ? "on"
                            : b.value;
                ...
                preFilter: {
                    ...
                    PSEUDO: function (g, h, l, m, q) {
                        if (g[1] === "not")
                            ...
                            n.match.POS.test(g[0]) ||
                            n.match.CHILD.test(g[0])
                        )
                            return true;
                        return g;
                    },
                ...
                filter: {
                    PSEUDO: function (g, h, l, m) {
                        ...
                        if (p) return p(g, l, h, m);
                            ...
                            k.error(
                                "Syntax error, unrecognized expression: " + q
                            );
                    },
                    CHILD: function (g, h) {
                        var l = h[1],
        ...
        s.querySelectorAll &&
            (function () {
                ...
                if (
                    !(
                        h.querySelectorAll &&
                        h.querySelectorAll(".TEST").length === 0
                    )
                ) {
                    k = function (m, q, p, v) {
                        q = q || s;
            ...
            if (
                ...
                if (g.getElementsByClassName("e").length !== 1) {
                    ...
                    n.find.CLASS = function (h, l, m) {
                        if (
                            typeof l.getElementsByClassName !== "undefined" &&
                            !m
                        )
            ...
            if (d)
                for (j = 0; e[j]; j++)
                    if (
                        ...
                        (!e[j].type ||
                            e[j].type.toLowerCase() === "text/javascript")
                    )
                        f.push(
                            e[j].parentNode
                    ...
                    f !== "border" &&
                        c.each(j, function () {
                            f ||
                                (e -=
                                    parseFloat(
                                        c.curCSS(a, "padding" + this, true)
                                    ) || 0);
                            if (f === "margin")
                                e +=
                                    parseFloat(
                                        c.curCSS(a, "margin" + this, true)
                                    ) || 0;
                            else
                                e -=
                                    parseFloat(
    ...
    c.extend({
            ...
            if (x) {
                ...
                try {
                    ...
                    if (e.ifModified) {
                        ...
                        c.etag[e.url] &&
                            x.setRequestHeader("If-None-Match", c.etag[e.url]);
                    }
                    r ||
                        x.setRequestHeader(
                            "X-Requested-With",
        ...
        handleError: function (a, b, d, f) {
            ...
            if (a.global)
                (a.context ? c(a.context) : c.event).trigger("ajaxError", [
                    b,
                    a,
                    f,
                ]);
        ...
        param: function (a, b) {
            ...
            function f(i, o) {
                ...
                e[e.length] =
                    encodeURIComponent(i) + "=" + encodeURIComponent(o);
            }
            var e = [];
    ...
    c.each(["Height", "Width"], function (a, b) {
        ...
        c.fn["outer" + b] = function (f) {
            return this[0]
                ? c.css(this[0], d, false, f ? "margin" : "border")
                : null;
        };
        c.fn[d] = function (f) {
            var e = this[0];
